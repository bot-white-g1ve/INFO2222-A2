...
def insert_user(username: str, password: str, public_key: str, private_key: str):
    with Session(engine) as session:
        user = User(username=username, password=password, pubKey=public_key, priKey=private_key)
        session.add(user)
        session.commit()
